...
export const ACTS: Act[] = [
  {
    ...
    scene: { art: 'newyear', caption: '年三十 · 窗外落雪', image: '/assets/jianzhi/scenes/scene-newyear.webp' },
  ...
  },
  {
    ...
    scene: { art: 'wedding', caption: '喜房 · 红烛高照', image: '/assets/jianzhi/scenes/scene-wedding.webp' },
  ...
  },
  {
    ...
    scene: { art: 'silk', caption: '灯下 · 驼铃渐远', image: '/assets/jianzhi/scenes/scene-silk.webp' },
  ...
  },
  {
    ...
    scene: { art: 'reunion', caption: '团圆夜 · 灯下围坐', image: '/assets/jianzhi/scenes/scene-reunion.webp' },
