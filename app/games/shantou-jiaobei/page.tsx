    ...
    <>
      ...
      <article className="jiaobei-guide" id="jiaobei-guide">
        ...
        <footer className="jiaobei-guide__sources">
          ...
          <p>
            <CultureLink from="shantou-jiaobei" href="/culture/jiaobei/">文化枢纽：潮汕掷筊</CultureLink>
            {' · '}
            <CultureLink from="shantou-jiaobei" href="/culture/jiaobei/sheng-yin-xiao/">圣阴笑含义</CultureLink>
            {' · '}
            <CultureLink from="shantou-jiaobei" href="/culture/jiaobei/how-to-read/">如何读杯</CultureLink>
            {' · '}
            <CultureLink from="shantou-jiaobei" href="/culture/jiaobei/online-vs-ritual/">在线与仪式</CultureLink>
          </p>
